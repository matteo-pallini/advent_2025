(ns advent-2025.core
  ...
  (:require [advent-2025.day03 :refer [day03-part1 day03-part2]]))
...
(defn -main
  ...
  []
      ...
      ;(println "\tDay 2 part 1:" (day02-part1 "data/day02/input.txt"))
      ;(println "\tDay 2 part 2:" (day02-part2 "data/day02/input.txt"))
      (println "\tDay 3 part 1:" (day03-part1 "data/day03/input.txt"))
      (println "\tDay 3 part 2:" (day03-part2 "data/day03/input.txt"))
      )